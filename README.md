...
Был создан рабочий прототип алгоритмов для динамического поиска маршрута, с последующей реализацией визуализации на примере игры.
...
![[Sravnpoln](images/sravn_algs.jpg)]
